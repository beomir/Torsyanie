...
<div id="logo">
 ...
 <div class="nav">
			<ol>
				...
				<li><a id ="link14c" href="#">Zmień język</a>
				<ul>
...
<a class = "link" href = "rejestracja.php">Rejestracja - załóż darmowe konto!</a>
 ...
 Zaloguj się i rozpocznij grę <span style= "color: yellow">Uratuj Torsjan</span>
 </br ></br >
...
Poniższa instrukcja jest podzielona na sekcje:</span>
...
</br></br> Wszystkie plemiona w grze handlują ze sobą więc jeżeli wysyłamy kupca do plemienia handlowego to uzyskamy nie wielki bonus w relacjach do lubiącego go plemienia wojennego. Poniżej jak wyglądają zarzyłości pomiędzy plemionami:
</br> Yerisi <--> Maurykowie
</br> Merkowie <--> Plemowie
</br> Opsydianie <--> Nordyskowie
<div id = "szpiegostwo"></div>						
	</ul>
</li>
